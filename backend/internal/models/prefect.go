...
// deputy_head, head, house_captain, vice_house_captain.
type AssignPrefectRequest struct {
	AcademicYearID string `json:"academic_year_id" binding:"required"`
	StudentID      string `json:"student_id" binding:"required"`
	Rank           string `json:"rank" binding:"required,oneof=junior senior deputy_head head house_captain vice_house_captain"`
}
