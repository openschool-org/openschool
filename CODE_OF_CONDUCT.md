...
repository, its issues, pull requests, and discussions), and also applies
...
reported to the project maintainers via a private message to a maintainer
account listed on the [openschool-org](https://github.com/openschool-org)
GitHub organization, or by opening a confidential report through GitHub's
...
tools if the behavior involves a security or safety concern. All complaints
